...
var colors = ['#2185C5', '#7ECEFD', '#FFF6E5', '#FF7F66']; // Functions
...
function () {
  function particle(x, y, radius, color) {
    ...
    this.update = function () {
      ...
      _this.y = y + Math.sin(_this.radians) * _this.distanceFromCenter.y; //console.log(innerWidth)

      _this.draw(); // to troubleshoot use console.log() and open the console in the browser
